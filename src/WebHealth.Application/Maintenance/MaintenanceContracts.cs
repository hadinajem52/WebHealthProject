...
public sealed record CreateMaintenanceWindow(MaintenanceScope Scope, DateTimeOffset StartsAt, DateTimeOffset EndsAt, string TimezoneId, string Reason, string SuppressionPolicy, bool PauseEscalation, bool ContinueFailureCounter);
public sealed record UpdateMaintenanceWindow(Guid MaintenanceWindowId, long Version, MaintenanceScope Scope, DateTimeOffset StartsAt, DateTimeOffset EndsAt, string TimezoneId, string Reason, string SuppressionPolicy, bool PauseEscalation, bool ContinueFailureCounter);
...
public sealed record MaintenanceWindowListItem(Guid Id, string ScopeLabel, DateTimeOffset StartsAt, DateTimeOffset EndsAt, string TimezoneId, string SuppressionPolicy, bool PauseEscalation, bool IsCancelled, long Version);
public sealed record MaintenanceWindowDetails(Guid Id, MaintenanceScope Scope, string ScopeLabel, DateTimeOffset StartsAt, DateTimeOffset EndsAt, string TimezoneId, string Reason, string SuppressionPolicy, bool PauseEscalation, bool ContinueFailureCounter, bool IsCancelled, long Version);
