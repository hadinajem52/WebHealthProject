    ...
    TimeProvider timeProvider) : IPngAuditResultSink
{
        ...
        DateTimeOffset recordedAt)
    {
        ...
        return new PngAuditImageResult
        {
            ...
            SemiTransparentPixelCount = facts?.Transparency?.SemiTransparentPixelCount,
            FullyTransparentPixelCount = facts?.Transparency?.FullyTransparentPixelCount,
            BackgroundTransparentPixelCount =
                facts?.Transparency?.BackgroundTransparentPixelCount,
            InteriorTransparentPixelCount = facts?.Transparency?.InteriorTransparentPixelCount,
            MinAlpha = facts?.Transparency?.MinAlpha,
            ...
            OptimizedPngBytes = comparison?.OptimizedPngBytes,
            CandidateWebpBytes = comparison?.CandidateWebpBytes,
            OriginalSavingsBytes = comparison?.OriginalSavingsBytes,
            OriginalSavingsPercent = comparison?.OriginalSavingsPercent,
            ReferenceSavingsBytes = comparison?.ReferenceSavingsBytes,
            ReferenceSavingsPercent = comparison?.ReferenceSavingsPercent,
