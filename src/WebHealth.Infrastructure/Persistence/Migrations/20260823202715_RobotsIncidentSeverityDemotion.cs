...
{
    /// <inheritdoc />
    public partial class RobotsIncidentSeverityDemotion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder) =>
            migrationBuilder.Sql(
                ...
                WHERE severity <> 'Warning'
                  ...
                  AND (issue_key LIKE 'v1|HttpAvailability|Seo.RobotsBlocksSite|%'
                       OR issue_key LIKE 'v1|HttpAvailability|Seo.RobotsBlocksEndpoint|%');
                """);
