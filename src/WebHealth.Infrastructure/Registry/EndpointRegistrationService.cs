    ...
    EndpointRegistryService endpointService) : IEndpointRegistrationService
{
    ...
    private static string? MapField(string? field, RegistrationLevel level) => level switch
    {
        ...
        RegistrationLevel.Endpoint => field switch
        {
            ...
            nameof(UpdateEndpoint.TargetAuthorizationKind) => EndpointRegistrationFields.TargetAuthorizationKind,
            nameof(UpdateEndpoint.TargetAuthorizationEvidence) => EndpointRegistrationFields.TargetAuthorizationEvidence,
            nameof(UpdateEndpoint.TargetAuthorizationExpiresAt) => EndpointRegistrationFields.TargetAuthorizationExpiresAt,
